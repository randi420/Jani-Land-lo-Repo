...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Jani_Music_bot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/randi420/Jani-Land-lo-Repo",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/bb70c80891918ef4fe5c0.jpg"
)
PING_IMG_URL = getenv(
